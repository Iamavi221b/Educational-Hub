    ...
    <div class="container-fluid">
        ...
        <form class="form">
            <div style="float: right">
                <button type="submit" formaction="/AdminMaterials/addTutorial" role="button" class="btn btn-primary">Add a new Tutorial</button><br><br>
            </div>
            ...
            <table class="table">
                ...
                <g:each in="${tutorial}">
                    <tr>
                        ...
                        <td>${it.name}</td>
                        <td>${it.sName.name}</td>
                        <td ><g:link id="${it.id}" action="updateTutorial" role="button" class="btn btn-primary">Update</g:link>
                        <g:link id="${it.id}" action="deleteTutorial" role="button" class="btn btn-danger">Delete</g:link>
                        </td>
                    </tr>
                </g:each>
                </tbody>
